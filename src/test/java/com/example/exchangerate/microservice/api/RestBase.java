...
public abstract class RestBase {
    ...
    public void setup() {
        ...
        RestAssuredMockMvc.standaloneSetup(MockMvcBuilders
                .standaloneSetup(appStatusController, customerController, accountController)
                .setMessageConverters(transactionMessageConverter).setControllerAdvice(responseEntityExceptionHandler));
    }
    ...
    private List<Account> getAccounts(Long customerId) {
        return List.of(getAccount(1L, customerId, Currency.CHF), getAccount(2L, customerId, Currency.GBP),
                getAccount(3L, customerId, Currency.CHF), getAccount(4L, customerId, Currency.EUR),
